...
BEZELS (BEZier splines for Estimating Limit Sets) performs tail inference for bivariate data with unit exponential marginal distributions. The package implements the methodology from [Majumder et. al. (2025), _Bayesian Analysis_](
https://doi.org/10.1214/25-BA1514).
